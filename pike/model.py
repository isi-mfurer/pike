...
from . import digest
from .exceptions import CallbackError, CreditError, RequestError, ResponseError, StateError, TimeoutError
import pike.io
            ...
            if req.credit_charge is None:
                ...
                for cmd in req:
                    if isinstance(cmd, smb2.ReadRequest) and cmd.length > 0:
                        ...
                        req.credit_charge, remainder = divmod(cmd.length, smb2.BYTES_PER_CREDIT)
